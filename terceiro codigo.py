...
while running:
    ...
    # TIMER DO POWER-UP
    if triple_shot_active:
        triple_shot_timer -= clock.get_time()
    ...
    # COLETAR POWER-UP
    pego = pygame.sprite.spritecollide(player, powerups, True)
    for p in pego:
        if p.tipo == "triple_shot":
            triple_shot_active = True
            triple_shot_timer = 5000
            POWERUP_SOM.play()

    # CHEFÃO APARECE COM 500 PONTOS
    ...
    if triple_shot_active:
        segundos = triple_shot_timer // 1000
